...
export const Wall = (onNavigate) => {
  ...
  onGetPosts((querySnapshot) => {
    ...
    querySnapshot.forEach((documentSnapshot) => {
      ...
      const likedByUser = post.likes.includes(currentUser.email); // aquí validamos si el usuario ya le dio like
    ...
    allPostsDiv.innerHTML = postHtml; // ---POSTS PUBLICADOS-3--- finalmente se introduce el html dentro del div de posts
